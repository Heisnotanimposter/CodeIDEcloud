...
import { Play, Plus, Share2, Sparkles, Code2, Brain, Zap, Users, Cloud, Settings, FolderOpen } from "lucide-react";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <section className="text-center py-16 px-6">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <Button variant="hero" size="lg" onClick={() => setActiveTab("notebook")} className="gap-2" data-test="start-coding">
                    <Play className="w-5 h-5" />
                    Start Coding
                  </Button>
                  <Button variant="outline" size="lg" className="gap-2" onClick={() => setActiveTab("environments")} data-test="browse-environments">
          ...
          <TabsContent value="projects" className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Button variant="hero" className="gap-2" data-test="new-project">
